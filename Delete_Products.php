...
<head>
    <title> Glizzard | Delete Product </title>
    <meta charset="utf-8"> 
    <style>
        title {color: white;}
...
else
{
 ...
 function action()
 {
   ...
   echo "<br> Product ID to deactivate <input type = 'input' name = 'delete'>";
 ...
 **************************************************************************/
 ...
 { 
   ...
   $q = "UPDATE products SET active='N' WHERE productID= $delete;"; 
   ...
   if ($r )
   {
       echo "Status Changed!";
	   echo"<br></br>";
	    echo '<br><a href="Display-Products.php"><h3>Show Updated Table!</h3></a></br>';
   }
   else
   {
